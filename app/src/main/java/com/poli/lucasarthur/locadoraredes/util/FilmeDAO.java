 ...
 */
public class FilmeDAO extends AsyncTask<String,Void,String> {

    FilmesActivity activity;
    Context context;
    private static SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");

    public FilmeDAO (FilmesActivity activity){
    ...
    protected void onPostExecute(String s) {
        ...
        filmes = gson.fromJson(s, listType);
        activity.setlist(filmes);
    }
